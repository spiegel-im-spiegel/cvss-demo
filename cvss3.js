 /**
  * JavaScript for CVSS (Common Vulnerability Scoring System) v3
  * These codes are licensed under CC0.
  * http://creativecommons.org/publicdomain/zero/1.0/deed.ja
  */

if ( typeof(CVSS3) == 'undefined' ) CVSS3 = function() {};

// --------------------------------------------------------------------
// Base Metrics Class
CVSS3.BaseMetrics = function(baseAV, baseAC, baseAu, baseC, baseI, baseA) {
...
//Attack Vector
CVSS3.BaseMetrics.prototype.setBaseAV = function(val) {
    switch (val) {
    case 0 : // Physical
        this.baseAV = 0.20;
        this.baseAV_vect = "AV:P";
        break;
    case 1 : // Local
        this.baseAV = 0.55;
        this.baseAV_vect = "AV:L";
        break;
    case 2 : // Adjacent Network
        this.baseAV = 0.62;
...
//Attack Complexity
CVSS3.BaseMetrics.prototype.setBaseAC = function(val) {
    switch (val) {
    case 0 : // High
        this.baseAC = 0.44;
...
//Privileges Required
CVSS3.BaseMetrics.prototype.setBasePR = function(val) {
    switch (val) {
    case 0 : // High
        this.basePR = 0.35;
        this.basePR_vect = "PR:H";
        break;
    case 1 : // Low
        this.basePR = 0.35;
        this.basePR_vect = "PR:L";
        break;
    default : //None
        this.basePR = 0.71;
        this.basePR_vect = "PR:N";
        break;
    }
};
//User Interaction
CVSS3.BaseMetrics.prototype.setBaseUI = function(val) {
    switch (val) {
    case 0 : // None
        this.baseUI = 0.35;
        this.baseUI_vect = "UI:N";
        break;
    default : //Required
        this.baseUI = 0.71;
        this.baseUI_vect = "UI:R";
        break;
    }
};
//Scope
CVSS3.BaseMetrics.prototype.setBaseS = function(val) {
    switch (val) {
    case 0 : // Unchanged
        this.baseS = 0.35;
        this.baseS_vect = "S:U";
...
CVSS3.BaseMetrics.prototype.setBaseC = function(val) {
    switch (val) {
    case 0 : // None
        this.baseC = 0.0;
        this.baseC_vect = "C:N";
...
//Integrity Impact
CVSS3.BaseMetrics.prototype.setBaseI = function(val) {
    switch (val) {
    case 0 : // None
        this.baseI = 0.0;
        this.baseI_vect = "I:N";
...
//Availability Impact
CVSS3.BaseMetrics.prototype.setBaseA = function(val) {
    switch (val) {
    case 0 : // None
        this.baseA = 0.0;
        this.baseA_vect = "A:N";
...
CVSS3.BaseMetrics.prototype.calcImpact = function(baseC, baseI, baseA) {
	return 10.41 * (1 - (1-baseC) * (1-baseI) * (1-baseA));
};
CVSS3.BaseMetrics.prototype.getScore = function() {
...
CVSS3.BaseMetrics.prototype.getVector = function() {
...
CVSS3.TemporalMetrics = function(temporalE, temporalRL, temporalRC, baseMetrics) {
    this.setTemporalE(temporalE);
    this.setTemporalRL(temporalRL);
    this.setTemporalRC(temporalRC);
    this.baseMetrics = baseMetrics;
};
CVSS3.TemporalMetrics.prototype.setTemporalE = function(val) {
    switch (val) {
    case 0 : // Unproven
        this.temporalE = 0.85;
...
CVSS3.TemporalMetrics.prototype.setTemporalRL = function(val) {
    switch (val) {
    case 0 : // Official Fix
...
CVSS3.TemporalMetrics.prototype.setTemporalRC = function(val) {
    switch (val) {
    case 0 : // Unconfirmed
...
CVSS3.TemporalMetrics.prototype.getScore = function() {
	var score = this.baseMetrics.getScore() * this.temporalE * this.temporalRL * this.temporalRC;
	score = score * 10.0;
	score = Math.round(score);
	return score / 10.0;
};
CVSS3.TemporalMetrics.prototype.getVector = function() {
	return this.temporalE_vect + "/" + this.temporalRL_vect + "/" + this.temporalRC_vect;
};

// --------------------------------------------------------------------
// Environmental Metrics Class
CVSS3.EnvironmentalMetrics = function(environmentalCD, environmentalTD, environmentalCR, environmentalIR, environmentalAR, temporalMetrics) {
...
CVSS3.EnvironmentalMetrics.prototype.setEnvironmentalCD = function(val) {
    switch (val) {
    case 0 : // None
...
CVSS3.EnvironmentalMetrics.prototype.setEnvironmentalTD = function(val) {
    switch (val) {
    case 0 : // None
...
CVSS3.EnvironmentalMetrics.prototype.setEnvironmentalCR = function(val) {
    switch (val) {
    case 0 : // Low
...
CVSS3.EnvironmentalMetrics.prototype.setEnvironmentalIR = function(val) {
    switch (val) {
    case 0 : // Low
...
CVSS3.EnvironmentalMetrics.prototype.setEnvironmentalAR = function(val) {
    switch (val) {
    case 0 : // Low
...
CVSS3.EnvironmentalMetrics.prototype.getScore = function() {
...
CVSS3.EnvironmentalMetrics.prototype.getVector = function() {
